...
<body>
	<form method="post" action="addmodule.do" onsubmit="return cansub()">
	    <table class="table table-striped table-bordered table-condensed list">
	        ...
	        <tbody>
	            <tr class="conheight">
	                ...
	                <td>
	                    <input type="text" id="modulename" name="module.modulename" class="span4" />
	                </td>
	            </tr>
	            <tr class="conheight">
	                <td>父菜单</td>
	                <td>
		                <select class="span4" name="module.fatherid">
				...
				<tr class="conheight">
	                <td>菜单路径 </td>
	                <td>
	                    <input type="text" name="module.modulepath" class="span4" value="/" />
	                </td>
				</tr>
				<tr class="conheight">
	                <td>&nbsp;操作</td>
